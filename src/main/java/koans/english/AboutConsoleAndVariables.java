...
public class AboutConsoleAndVariables {
    ...
    public static void askAndDisplayNameOnASingleLineInConsole() {
        System.out.println("What is your name?");
        String someText = readLine();
        System.out.println("Your name is: " + someText);
    ...
    public static void askNameAndAgeInConsole() {
        ...
        String someText2 = readLine();
        System.out.println("Your name is "+someText1+" and your age is "+someText2+".");
    ...
    public static void computeAgeIn5YearsConsole() {
        System.out.println("What is your age?");
        String someText = readLine();
        int nbOfOragesAfterIAteOne = Integer.parseInt(someText);
        System.out.println("In 5 years from now, you will be " + (nbOfOragesAfterIAteOne + 5) + ".");
    }
}
